...
<html lang="pt-br">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="frança.css">
	...
	<body>
		...
		<!-- na tag <a> vai algum link que direcione para o quem somos ou para a própria página inicial -->
					...
					<div id="menu">
						<ul>
							...
							<li class="menu-item submenu"> 
								<a href="traballhe_conosco.php">Rick Viagens</a> 								
							</li>
						</ul>
					</div>
		...
		<section class="container">			
			...
			<div id="galeria">		
				<div class="conteudo">
					<div>
						<img src="image/franca.jpg" alt="Paris">
					</div>
					<h4>Paris</h4>
				...
				<div class="conteudo">
					<div>
						<img src="image/nice.jpg" alt="Nice">	
					</div>		
					<h4>Nice</h4>
